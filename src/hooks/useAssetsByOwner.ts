...
const fetchAsset = async (mintAddress?: string) => {
  return mintAddress ? helius.rpc.getAssetsByOwner({ownerAddress: mintAddress, page: 1, limit: 100, sortBy: {sortBy: AssetSortBy.Created, sortDirection: AssetSortDirection.Asc}}) : undefined;
};
